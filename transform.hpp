#ifndef BVH_TRANSFORM_HPP
#define BVH_TRANSFORM_HPP
...
struct Transform {
    ...
    void apply(std::array<double, 3> &v) const {
        ...
        float new_z = matrix.data[2][0] * v[0] + matrix.data[2][1] * v[1] + matrix.data[2][2] * v[2] + matrix.data[2][3];
